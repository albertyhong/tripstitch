...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { description: @destination.description, location: @destination.location, name: @destination.name, rating: @destination.rating }
    end
  ...
  test "should update destination" do
    put :update, id: @destination, destination: { description: @destination.description, location: @destination.location, name: @destination.name, rating: @destination.rating }
    assert_redirected_to destination_path(assigns(:destination))
  end
